...
In this project, we learned how to use redis, and how to interact with its server with Node and Express.
...
## 1. Node Redis Client
Install [node_redis](https://github.com/redis/node-redis "node_redis") using npm
